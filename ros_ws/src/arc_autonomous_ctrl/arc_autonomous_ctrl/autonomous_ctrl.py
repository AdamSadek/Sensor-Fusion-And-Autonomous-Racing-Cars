...
class AutonomousRCCarNode(Node):
    ...
    def determine_speed_based_on_angle(self, angle):
        ...
        if angle > sharp_turn_angle:
            self.pid_controller.kp = 0.00095 
            self.pid_controller.kd = 0.00035
            return 0.5  # slow down for sharp turns
        elif angle > mild_turn_angle and angle < sharp_turn_angle:
            self.pid_controller.kp = 0.00055  
            self.pid_controller.kd = 0.00025 
            return 0.75  # moderate speed for mild turns
        else:
            self.pid_controller.kp = 0.00030 
            self.pid_controller.kd = 0.00015 
